<%-- 
    Document   : login
    Created on : Oct 27, 2022, 3:29:59 AM
    Author     : user
--%>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form id="register-form" action="signup" method="post" role="form" style="display: none;">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="amount" id="amount" tabindex="1" class="form-control" placeholder="Amount" value="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="conpass" id="confirm-password" tabindex="2" class="form-control" placeholder="Confirm Password">
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6 col-sm-offset-3">
